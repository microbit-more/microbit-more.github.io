...
Microbit More 用プログラム [microbit-mbit-more-v2-0_2_0.hex](https://github.com/yokobond/pxt-mbit-more-v2/releases/download/0.2.0/microbit-mbit-more-v2-0_2_0.hex)
...
ウェブブラウザで https://microbit-more.github.io/ を開きます。
